...
@app.route("/produto")
def produto():
    p = {"nome": "Caderno", "preco": 12.50, "estoque": 0, "marca": "Tilibra"}
...
def vitrine():
    produtos = [
        {
            "nome": "Amigurumi de Ursinho",
            "descricao": "Ursinho artesanal feito em crochê.",
            "preco": 45.00,
            "disponivel": True,
        },
        {
            "nome": "Bolsa de Crochê",
            "descricao": "Bolsa artesanal feita com fio de algodão.",
            "preco": 70.00,
            "disponivel": True,
        },
        {
            "nome": "Tapete de Crochê",
            "descricao": "Tapete artesanal para decorar a casa.",
            "preco": 55.00,
            "disponivel": False,
        },
    ]
